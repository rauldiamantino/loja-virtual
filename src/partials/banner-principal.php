<section id=<?= $banner["id"] ?> class="relative w-full h-min css-banner-principal">
  <section class="text-black/30 cursor-pointer css-banner-principal-botoes">    
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-10 h-10 hover:text-black/70 absolute top-1/2 left-2 translate-y-[-50%] css-banner-principal-btn-left" viewBox="0 0 16 16">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-10 h-10 hover:text-black/70 absolute top-1/2 right-2 translate-y-[-50%] css-banner-principal-btn-right" viewBox="0 0 16 16">
