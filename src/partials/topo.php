<header class="sticky top-0 z-50 bg-white css-topo">
    ...
    <section class="lg:p-0 lg:px-10 p-4 h-full flex flex-row justify-between items-center relative css-topo-menu">
      <span class="font-bold css-topo-logo">LOGO</span>
      ...
      <section class="flex items-center gap-6 css-topo-box-direita">
        <section class="lg:relative absolute top-full left-0 right-0 group css-topo-box-direita-pesquisar">
          ...
          <div class="p-2 absolute top-1/2 -translate-y-1/2 left-1 hover:bg-neutral-200 rounded-full cursor-pointer">
